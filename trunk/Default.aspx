...
--%>
    ...
    <div  id = "mainDiv" style ="background:white; direction:rtl; float:left;width:760px;">   
                                            ...
                                            <div style=" background:White; border:1px solid white; color:#404142; ">
                                                <h2 style="text-align:right; "> ברוכים הבאים לאתר עגליסט   </h2>
                                                   ...
                                                   <div class="CenterPanelTextDiv">
                                                        ...
                                                        <a href = "TipsPage.aspx">לקבל טיפים לקניה חכמה בסופר</a> <br/><br/>
                                                        </h5>
                                                    </div>
                                            </div>
                                            <div style = " clear : both;"></div>
                            ...
                            <div class="CentralPanelDiv">    
                                ...
                                <div class="TipsDiv">
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                        <ContentTemplate>
                                            <div id = "SavedBasketsDiv" class = "SavedBasketsDiv" style = " overflow :auto;">
                                    ...
                                    <div class="CenterOfCenterPageDiv">  
                                        ...
                                        <div id="FindProductDefDiv" dir="ltr" >                   
                                            ...
                                            <div style="float:left; background-color:White; width:380px;  ">
                                                ...
                                                <div style ="height:50px; text-align:center; font-weight:bolder; margin-bottom:10px;"> 
                                                            <asp:Label ID="Label1" runat="server" > 
                                                            <img src="Images/MediumLine.jpg"/>
                                                            <br/>
                                                            <a href = "RegisterUser.aspx"> לעידכון הרשימה ולניהול רשימה אישית </a></asp:Label>
